...
<article class="wp-block-group query-entry">
    ...
    <div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--10);padding-top:0">
        <!-- wp:post-title {"level":3,"isLink":true,"style":{"layout":{"flexSize":"min(2.5rem, 3vw)","selfStretch":"fixed"},"typography":{"fontStyle":"normal","fontWeight":"700"},"elements":{"link":{"color":{"text":"var:preset|color|typography"}}}},"fontSize":"large"} /-->
    </div>
    <!-- /wp:group -->
</article>
<!-- /wp:group -->
